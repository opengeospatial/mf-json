...
[source]
.Example: To insert a list of moving feature data into the service with the "application/geo+json-seq" content type.
----
>>> Request
POST  SERVICE_ROOT/MovingFeatures   HTTP1.1
...
[source]
.Example: To retrieve a temporal property information whose name is 'dose'.
----
>>> Request
...
[source]
.Example: stBoundedBy of moving features.
----
>>> Request
...
[source]
.Example: To get a list of names of FeatureLayer.
----
>>> Request
...
[source]
.Example: To get a list of static properties' name.
----
>>> Request
...
[source]
.Example: To get a value of a static properties.
----
>>> Request
...
[source]
.Example: To get a list of temporal properties' name.
----
>>> Request
...
[source]
.Example: To get a unit value of a temporal property
----
>>> Request
