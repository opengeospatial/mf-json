...
The symbolic resource `$value` is allowed to resolve to a single property value or to get a list of values of TemporalProperties' elements of a MovingFeatures resource in text/plain form.
