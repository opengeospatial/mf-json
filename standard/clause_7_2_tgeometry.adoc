...
from the right-handed local engineering coordinate reference system to the Universal Transverse Mercartor (UTM) system as a type of plane rectangular coordinate system.
