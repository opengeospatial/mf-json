...
* *MultiMovingPoint*: An element of the "prisms" member SHALL be a JSON array of TemporalPrimitiveGeometry instances of type `"MovingPoint"`.
...
* *MultiMovingLineString*: An element of the "prisms" member SHALL be a JSON array of TemporalPrimitiveGeometry instances of type `"MovingLineString"`.
...
* *MultiMovingPolygon*: An element of the "prisms" member SHALL be a JSON array of TemporalPrimitiveGeometry instances of type `"MovingPolygon"`.
