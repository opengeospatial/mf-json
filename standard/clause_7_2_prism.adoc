...
The UML diagram for MF-JSON Prism is depicted in <<mf-prism-uml>>.

[#mf-prism-uml,reftext='{figure-caption} {counter:figure-num}']
.Class diagram for MF-JSON Trajectory
image::mf-geojson-prism.png[mf-prism-uml, pdfwidth=95%, width=95%, align="center"]
...
When a document mixed two formats of MF-JSON Prism and MF-JSON Trajectory, MF-JSON Prism has priority to interpret the movement of a feature.
A sample data of MF-JSON Prism is provided in <<sampleJSONPrism>>.
