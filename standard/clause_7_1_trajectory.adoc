...
encoded as a JSON string of https://www.iso.org/iso-8601-date-and-time-format.html[ISO 8601] field-based formats using Z (e.g., 2016-09-11T06:10:32Z)
or incremental time as the number of milliseconds since midnight (00:00 a.m.) on January 1, 1970 in UTC (e.g., 1465621816590).
[NOTE]
