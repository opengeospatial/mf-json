...
[width="99%", cols="1,3,2, 2, 2", options="header"]
|===========================================================
|Name |Description | Data type | Multiplicity and use | Editable
|@id	| It is the unique and system-generated identifier. Clients cannot edit its value. | Any | One (mandatory) | NO
|temporalGeometry | A JSON object representing a temporal geometry. | JSON Object |  One (mandatory) |YES
|temporalProperties | A JSON array containing temporal properties or a JSON null value. |  JSON Array | Zero-to-many | YES
|properties | A JSON Object containing static properties as key-value pairs or a JSON null value. | JSON Object | Zero-to-one | YES
|===========================================================
...
|===========================================================
|Name |Description | Data type | Multiplicity and use | Editable
|type	|Its value is one of "MovingPoint", "MovingLineString", "MovingPolygon", "MultiMovingPoint", "MultiMovingLineString", "MultiMovingPolygon", and "MovingGeometryCollection". | CharacterString | One (mandatory) | NO
|coordinates | A collection of lists of sampled coordinates to represent spatial movements or a JSON null value (for collection). | JSON Array |  One-to-many | YES
|datetimes | A collection of datetimes when the coordinates are sampled or a JSON null value (for collection). |  JSON Array | One-to-many | YES
|members | A Navigation property to address temporal-geometry elements of the collection types such as "MultiMovingPoint", "MultiMovingLineString", "MultiMovingPolygon", and "MovingGeometryCollection". A simple case is a JSON null value. |  JSON Array | Zero-to-many | YES/NO
|interpolations| A Navigation property to address the interpolation information. | JSON Object/Array | One-to-many | NO
|===========================================================
...
|===========================================================
|Name |Description | Data type | Multiplicity and use | Editable
|name	| A name of dynamic attribute of feature. | CharacterString | One (mandatory) | YES (but, no duplication within a moving feature.)
|uom | A symbol or URI to address the unit of measurement. | URI | Zero-to-one | YES
|values | A collection of sampled values to represent dynamic changes of feature attribute. | Any | One-to-many | YES
|datetimes | A collection of datetimes when the values are sampled. | JSON Array | One-to-many | YES
|interpolations| A Navigation property to address the interpolation information. | JSON Object/Array | One-to-many | NO
|===========================================================

- *Property Class*: It is a type for accessing the static properties of moving features. A Property resource is optional to be implemeted in a moving-feature service. The minimum properties for the implementation are defined by:

[width="99%", cols="1,3,2, 2, 2", options="header"]
|===========================================================
|Name |Description | Data type | Multiplicity and use | Editable
|name	| A name of feature attribute. | CharacterString | One (mandatory) | YES (but, no duplication within a moving feature.)
|value | A value of feature attribute. | Any | One (mandatory) | YES
|===========================================================
...
- *FeatureLayer Class*: It is a collection of moving features to manage data in a distinct (physical or logical) space; however, it is an optional resource and can be replaced by an Application-dependent feature.
...
OGC Moving Feature Access provides the implementation specification as a common design to support moving feature data into a database, data service, or application using various programming languages or protocols (e.g., SQL, Java, and HTTP).
...
image::restinterfaces.png[Moving Feature Interfaces, pdfwidth=100%, width=75%]
